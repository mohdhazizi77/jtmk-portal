                            ...
                            <div class="media">
                                <div class="media-body">
                                    <div class="greeting-user">
                                        <h4 class="f-w-600">Selamat datang ke <span class="fs-3">JTMK Portal</span></h4>
                                        <h3 class="font-light fw-bold">{{ now()->format('d F Y') }}</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="cartoon"><img class="img-fluid" src="{{ asset('assets/images/dashboard/cartoon.svg') }}"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Senarai Penuh Ketidakhadiran & Pergerakan Staf JTMK</h5>
                        </div>
                        <div class="card-body">
                            <p class="fw-bold">CUTI REHAT</p>
                            <table class="table table-responsive w-100">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>NUR ATIQAH BINTI MOHD NASIR</td>
                                    <td>25/09/2025</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>NURUL AIN BINTI AMIR ADLI</td>
                                    <td>03/10/2025</td>
                                </tr>
                                </tbody>
                            </table>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>To use PUG it required node.js and basic knowledge of using it. Using PUG as template engine to generate whole template quickly with your selected layout and other custom changes. To getting start with PUG usage & template generating process please refer template
                            documentation.</p>
